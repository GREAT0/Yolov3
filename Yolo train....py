...
def _main():
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='D:/YOLO_THESIS/Dataset/model.h5')
    else:
        model = create_model(input_shape, anchors, num_classes, freeze_body=2,
                weights_path='D:/YOLO_THESIS\Yolowork/YOLOv3-object-detection-tutorial-master/YOLOv3-CSGO-detection/logs/trained_weights_final_2.h5') # make sure you know what you freeze
